...
if __name__ == '__main__':
    ...
    hp_search = EpsilonGreedyESNSearch(X_train, Y_train, X_test, Y_test, n_iterations=20, n_reservoirs=4, epsilon_greedy=0.3)
